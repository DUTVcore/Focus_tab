...
**Focus Tab** là một tiện ích mở rộng cho Chrome (Chrome Extension) được xây dựng với mục đích thay thế trang "New Tab" nhàm chán mặc định.
...
* **⚙️ Quick Settings:** Giao diện cài đặt dạng Modal kính mờ (Glassmorphism), cho phép thay đổi hình nền, font chữ, kích thước chỉ trong 1 nốt nhạc.
...
Hiện tại dự án đang ở dạng **Developer Preview**, bạn có thể cài đặt thủ công ("Side-load") như sau:
...
4.  Bấm nút **Load unpacked** -> Chọn thư mục `Focus_tab` vừa clone về.
